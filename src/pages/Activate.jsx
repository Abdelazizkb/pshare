...
function Activate() {
  ...
  const show = activated ? <Done/> : <Spin/>
  return (
      <>
        {show}
      </>
...
export const Done=()=>{
    return (<div className="fixed top-0 left-0 w-full h-screen bg-white flex  items-center justify-center">
                ...
                <div className="font-bold text-2xl mx-2">Votre compte a été activé</div>
            </div>)
}
...
export const Spin=()=>{
    return (<div className="fixed top-0 left-0 w-full h-screen bg-white flex  items-center justify-center">
                ...
                <div className="font-bold text-2xl mx-2">Activation de votre compte...</div>
            </div>)
}
