...
export const signUp = (email,first_name,last_name,birthday,phone,inn,password,re_password,company) => async (dispatch) => {
    ...
    axios.post(`http://localhost:8000/auth/users/`, body, config)
        .then(res => {
            dispatch({
                type: SIGNUP_SUCCESS,
            })
...
export const loadCategories= () => async (dispatch) =>{
    ...
    try {
        const res = await axios.get(`http://localhost:8000/auth/category/list/`);
        dispatch({
...
export const loadCompanies= () => async (dispatch) =>{
    ...
    try {
        const res = await axios.get(`http://localhost:8000/auth/company/list/`);
        dispatch({
